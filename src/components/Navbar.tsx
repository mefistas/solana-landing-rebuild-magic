      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center">
            <button
              className="ml-4 bg-gradient-to-r from-solana-purple to-solana-dark-purple hover:opacity-90 text-white px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 hidden md:block"
            >
              Launch App
            </button>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-black border-t border-gray-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button className="w-full mt-4 bg-gradient-to-r from-solana-purple to-solana-dark-purple hover:opacity-90 text-white px-4 py-2 rounded-full text-sm font-medium transition-all duration-200">
              Launch App
            </button>
          </div>
        </div>
