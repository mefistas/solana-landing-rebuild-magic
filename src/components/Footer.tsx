      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-xl font-bold mb-6">Solabs</h3>
            <p className="text-gray-400 mb-4">
              Building the future of blockchain integration
            </p>
            <div className="flex space-x-4">
              <a href="https://twitter.com/solana" className="text-gray-400 hover:text-white">
                <span className="sr-only">Twitter</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="https://discord.com/invite/solana" className="text-gray-400 hover:text-white">
              ...
              <a href="https://github.com/solana-labs" className="text-gray-400 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="https://docs.solana.com/" className="hover:text-white">Documentation</a></li>
              <li><a href="https://solana.com/developers" className="hover:text-white">Resources</a></li>
              <li><a href="https://solana.com/developers/guides" className="hover:text-white">Guides</a></li>
              <li><a href="https://solana.com/ecosystem" className="hover:text-white">Ecosystem</a></li>
            </ul>
          </div>
