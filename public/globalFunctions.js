...
// Ensure script runs in browser environment
(function() {
  console.log("globalFunctions.js loading");
  ...
  try {
    ...
    console.log("Successfully defined window.openModal function");
  } catch (err) {
    console.error("Failed to define window.openModal:", err);
  }
  ...
  console.log("globalFunctions.js loaded successfully");
})();
